...
## 使用更新器更新
Windows 下需要使用 HINATAUT 来更新固件，Windows 11 可以直接运行
::: warning
Windows 10 则可能需要在 Microsoft Store 安装 [Windows Terminal](https://apps.microsoft.com/detail/9n0dx20hk701) 才可正常运行
:::
