...
::: tip 提示
网页控制中心的大多数功能（如读卡器设置、固件更新等）已被 **HINATA Go** 替代。

目前该页面**仅用于卡片写入（写入白卡）**功能。如需修改其他设置或在支持的平台上更新固件，请使用 [HINATA Go](/go/index.md)。
:::
...
请参照 [使用 HINATA Client 更新（Windows）](../update/index.md#使用-hinata-client-更新-windows)
:::
